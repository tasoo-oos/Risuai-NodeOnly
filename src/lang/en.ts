...
export const languageEnglish = {
    ...
    modelPresetFolderDefault: "New folder",
    modelPresetFolderName: "Folder name",
    modelPresetFolderRename: "Rename folder",
    modelPresetFolderDelete: "Dissolve folder",
    modelPresetFolderDeleteConfirm: "Dissolve this folder? Its presets will remain at the same position.",
    modelPresetFolderEmpty: "No presets in this folder",
    modelPresetDropCreateFolder: "Create folder",
    modelPresetDropIntoFolder: "Move into folder",
    ...
    claudeCachingRetrivalDesc:
        "Extends the cache time for Claude Caching, by requesting every 4 minutes. this can reduce the cache miss rate, but it can increase the cost if its not used properly. It is not applied to the preset request.",
    ...
    requestStatus: {
        ...
        batchSubmitting: "Anthropic batch submitting...",
