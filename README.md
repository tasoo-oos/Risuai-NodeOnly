...
- Support the project: [Patreon](https://patreon.com/PocketRisu/membership) — entirely optional; supporters can have their name listed in the app, with no extra features or perks
